...
import {
  init_punycode,
  punycode_exports
} from "/myst-test/build/_shared/chunk-FARIIZJL.js";
...
import {
  VFile
} from "/myst-test/build/_shared/chunk-JMLHSHJF.js";
...
// ../../node_modules/myst-parser/dist/esm/plugins.js
var plugins_exports = {};
...
var import_markdown_it_front_matter = __toESM(require_markdown_it_front_matter());
...
// ../../node_modules/markdown-it-myst/dist/esm/nestedParse.js
...
// ../../node_modules/markdown-it-myst/dist/esm/roles.js
...
// ../../node_modules/markdown-it-myst/dist/esm/utils.js
...
// ../../node_modules/markdown-it-myst/dist/esm/directives.js
...
// ../../node_modules/markdown-it-myst/dist/esm/index.js
...
// ../../node_modules/myst-parser/dist/esm/math.js
...
// ../../node_modules/myst-parser/dist/esm/myst.js
var import_markdown_it = __toESM(require_markdown_it());

// ../../node_modules/myst-directives/dist/esm/admonition.js
...
// ../../node_modules/myst-directives/dist/esm/bibliography.js
...
// ../../node_modules/myst-directives/dist/esm/code.js
var codeDirective = {
  name: "code",
  arg: {
    type: ParseTypesEnum.string
...
// ../../node_modules/myst-directives/dist/esm/dropdown.js
...
// ../../node_modules/myst-directives/dist/esm/embed.js
var embedDirective = {
  name: "embed",
  options: {
    label: {
    ...
    return [
      {
        ...
        label,
        identifier,
        "remove-input": (_b = data.options) === null || _b === void 0 ? void 0 : _b["remove-input"],
        "remove-output": (_c = data.options) === null || _c === void 0 ? void 0 : _c["remove-output"]
      }
    ];
  }
};

// ../../node_modules/myst-directives/dist/esm/figure.js
var figureDirective = {
  name: "figure",
  arg: {
    type: ParseTypesEnum.string,
  ...
  run(data) {
    ...
    const children = [img];
    if (data.body) {
      const [caption, ...legend] = data.body;
      if (caption) {
    ...
    const { label, identifier } = normalizeLabel((_e = data.options) === null || _e === void 0 ? void 0 : _e.name) || {};
    const container = {
      type: "container",
      kind: "figure",
      identifier,
      label,
      class: (_f = data.options) === null || _f === void 0 ? void 0 : _f.class,
      children
    };
    return [container];
  }
...
// ../../node_modules/myst-directives/dist/esm/iframe.js
var iframeDirective = {
  name: "iframe",
  arg: {
    type: ParseTypesEnum.string,
...
// ../../node_modules/myst-directives/dist/esm/image.js
var imageDirective = {
  name: "image",
  arg: {
    type: ParseTypesEnum.string,
...
// ../../node_modules/myst-directives/dist/esm/include.js
...
// ../../node_modules/myst-directives/dist/esm/table.js
...
// ../../node_modules/myst-directives/dist/esm/margin.js
var marginDirective = {
  name: "margin",
  body: {
    type: ParseTypesEnum.parsed,
...
// ../../node_modules/myst-directives/dist/esm/math.js
var mathDirective = {
  name: "math",
  options: {
    label: {
...
// ../../node_modules/myst-directives/dist/esm/mdast.js
var mdastDirective = {
  name: "mdast",
  arg: {
    type: ParseTypesEnum.string,
...
// ../../node_modules/myst-directives/dist/esm/mermaid.js
...
// ../../node_modules/myst-directives/dist/esm/mystdemo.js
var mystdemoDirective = {
  ...
  run(data) {
    ...
    if ((_a = data.options) === null || _a === void 0 ? void 0 : _a.numbering) {
      try {
        numbering = js_yaml_default.load(data.options.numbering);
      } catch (err) {
      }
    }
    return [
...
// ../../node_modules/myst-directives/dist/esm/output.js
var outputDirective = {
  name: "output",
  options: {
    id: {
...
// ../../node_modules/myst-directives/dist/esm/index.js
...
// ../../node_modules/myst-roles/dist/esm/abbreviation.js
var ABBR_PATTERN = /^(.+?)\(([^()]+)\)$/;
...
// ../../node_modules/myst-roles/dist/esm/chem.js
var chemRole = {
...
// ../../node_modules/myst-roles/dist/esm/cite.js
var citeRole = {
  name: "cite:p",
  alias: ["cite:t", "cite"],
  body: {
  ...
  run(data) {
    ...
    const children = labels.map((l) => {
      var _a;
      const { label, identifier } = (_a = normalizeLabel(l)) !== null && _a !== void 0 ? _a : {};
      return {
        type: "cite",
...
// ../../node_modules/myst-roles/dist/esm/delete.js
var deleteRole = {
  name: "delete",
  alias: ["del", "strike"],
  body: {
...
// ../../node_modules/myst-roles/dist/esm/math.js
var mathRole = {
  name: "math",
  body: {
    type: ParseTypesEnum.string,
...
// ../../node_modules/myst-roles/dist/esm/reference.js
var REF_PATTERN = /^(.+?)<([^<>]+)>$/;
var refRole = {
  name: "ref",
  alias: ["eq", "numref"],
...
// ../../node_modules/myst-roles/dist/esm/si.js
var siRole = {
  name: "si",
  body: {
    type: ParseTypesEnum.string,
...
// ../../node_modules/myst-roles/dist/esm/smallcaps.js
var smallcapsRole = {
  name: "smallcaps",
  alias: "sc",
  body: {
...
// ../../node_modules/myst-roles/dist/esm/subscript.js
var subscriptRole = {
  name: "subscript",
  alias: "sub",
  body: {
...
// ../../node_modules/myst-roles/dist/esm/superscript.js
var superscriptRole = {
  name: "superscript",
  alias: "sup",
  body: {
...
// ../../node_modules/myst-roles/dist/esm/underline.js
var underlineRole = {
  name: "underline",
  alias: "u",
  body: {
...
// ../../node_modules/myst-roles/dist/esm/index.js
var defaultRoles = [
  abbreviationRole,
  chemRole,
  citeRole,
...
// ../../node_modules/myst-parser/dist/esm/config.js
...
// ../../node_modules/myst-parser/dist/esm/tokensToMyst.js
var import_he = __toESM(require_he());
init_unist_util_visit();
init_unist_util_select();

// ../../node_modules/myst-parser/dist/esm/fromMarkdown.js
...
var defaultMdast = {
  ...
  fence: {
    ...
    getAttrs(t) {
      ...
      const showLineNumbers = !!(((_b = t.meta) === null || _b === void 0 ? void 0 : _b.linenos) || ((_c = t.meta) === null || _c === void 0 ? void 0 : _c.linenos) === null || ((_d = t.meta) === null || _d === void 0 ? void 0 : _d["number-lines"]) || ((_e = t.meta) === null || _e === void 0 ? void 0 : _e["lineno-start"]));
      ...
      return Object.assign(Object.assign({ lang: getLang(t) }, normalizeLabel(name)), {
  ...
  table: {
    ...
    getAttrs(token) {
      ...
      return Object.assign(Object.assign({ kind: void 0 }, normalizeLabel(name)), { enumerated: (_b = token.meta) === null || _b === void 0 ? void 0 : _b.enumerated, class: getClassName(token, [NUMBERED_CLASS, ALIGN_CLASS]), align: ((_c = token.meta) === null || _c === void 0 ? void 0 : _c.align) || void 0 });
    }
  },
  thead: {
    type: "_lift"
  ...
  math_block: {
    ...
    getAttrs(t) {
      ...
      return Object.assign(Object.assign({}, normalizeLabel(name)), { enumerated: (_a = t.meta) === null || _a === void 0 ? void 0 : _a.enumerated });
    }
  },
  math_block_label: {
    type: "math",
...
// ../../node_modules/myst-parser/dist/esm/directives.js
init_unist_util_select();

// ../../node_modules/myst-parser/dist/esm/roles.js
init_unist_util_select();
...
function parseOptions(opts) {
  ...
  const parsedOpts = {
    ...
    mdast: Object.assign(Object.assign({}, defaultOptions2.mdast), opts === null || opts === void 0 ? void 0 : opts.mdast),
    markdownit: Object.assign(Object.assign({}, defaultOptions2.markdownit), opts === null || opts === void 0 ? void 0 : opts.markdownit),
    extensions: Object.assign(Object.assign({}, defaultOptions2.extensions), opts === null || opts === void 0 ? void 0 : opts.extensions),
...
//# sourceMappingURL=/myst-test/build/_shared/esm-TV6SF4QT.js.map
